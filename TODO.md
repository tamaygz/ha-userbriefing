...
- [x] [Implement core composer logic that sorts promoted alerts to the top of the briefing before standard snippet content.](https://github.com/tamaygz/ha-userbriefing/issues/18)
...
- [x] [Add coordinator and rendering tests for alert severity ordering and alert promotion above normal content.](https://github.com/tamaygz/ha-userbriefing/issues/25)
...
- [x] [Add custom_text provider and push_snippet service so automations can inject any content into the briefing (automation-driven "anything adapter" with bundled blueprints).](https://github.com/tamaygz/ha-userbriefing/issues/34)
- [ ] [Implement home_status provider with real entity collection](https://github.com/tamaygz/ha-userbriefing/issues/53)
- [ ] [Implement news_headlines provider with adapter-backed data source](https://github.com/tamaygz/ha-userbriefing/issues/54)
- [ ] [Implement beach_conditions and wind_conditions providers](https://github.com/tamaygz/ha-userbriefing/issues/55)
- [ ] [Implement real deliver routing or formally downgrade deliver to preview-only](https://github.com/tamaygz/ha-userbriefing/issues/56)
- [ ] [Define and document a voice delivery contract for voice_future](https://github.com/tamaygz/ha-userbriefing/issues/57)
- [ ] [Add mail_summary provider adapter path or formally freeze as post-v1](https://github.com/tamaygz/ha-userbriefing/issues/58)
- [ ] [Add schedule helper or example automation for routine briefing generation](https://github.com/tamaygz/ha-userbriefing/issues/59)
